...
export const questions = [
    ...
    },
    {
        ...
        isTrue: false,
        correctAnswer: 'Это ложь! Искусственный интеллект может лишь помогать, но код пишут сотрудники.',
        incorrectAnswer: 'На самом деле искусственный интеллект может помогать, но код пишут сотрудники.',
        answerFont: 20,
        pic: {
            src: q4,
            height: 375,
